...
const Form: React.FunctionComponent<FormProps> = () => {
	...
	return (
		<section className="max-w-screen-xl mx-auto mt-10">
			<div>
				<h2 className="text-3xl font-title border-l-4 pl-2 ml-4 md:ml-0 border-l-primary uppercase">
					CONTACTENOS
				</h2>
			</div>
			<div className="mt-10">
				...
				>
					<Formulario className="flex flex-col justify-center items-center mx-auto p-3 max-w-sm shadow-md rounded px-8 pt-6 pb-8 mb-4 bg-bg_secondary">
						<div className=" text-xl  w-full">
							<label
								htmlFor="fullname"
								className="block text-lg font-bold pt-2 pb-1 border-l-primary"
							>
								Nombre Completo
							</label>
							<Field
						...
						<div className=" text-xl  w-full">
							<label
								className="block text-lg font-bold pt-2 pb-1"
								htmlFor="phone"
							>
								Telefono
							</label>
						...
						{loading ? (
							...
							<button
								className="bg-primary text-white font-bold py-2 px-4 mt-3 w-full rounded hover:bg-gray-600"
								type="submit"
							>
								Enviar
							</button>
